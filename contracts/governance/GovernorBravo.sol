...
contract GovernorBravoEvents {
    ...
    event ProposalCreated(
        ...
        string[] signatures, 
        bytes[] calldatas, 
        uint startBlock, uint endBlock, string description);
...
contract GovernorBravoDelegateStorageV1 is GovernorBravoDelegatorStorage {
    ...
    /// @notice The address of the Soul Protocol Timelock
    TimelockInterface public timelock;

    /// @notice The address of the Soul Power (SOUL) governance token
    SoulInterface public soul;
...
contract GovernorBravoDelegator is GovernorBravoDelegatorStorage, GovernorBravoEvents {
	constructor(
        ...
        delegateTo(
            implementation_, 
            abi.encodeWithSignature("initialize(address,address,uint256,uint256,uint256)",
            timelock_,
            soul_,
            votingPeriod_,
            votingDelay_,
