...
///@author Zapper
///@notice This contract adds liquidity to SoulSwap pools using ETH or any ERC20 Token.
...
contract Context {
    ...
    function _msgData() internal view returns (bytes memory) {
        this; // silence state mutability warning w/o gen. bytecode - https://github.com/ethereum/solidity/issues/2691
        return msg.data;
    }
}
...
contract SoulSwap_ZapIn_General_V3 is ReentrancyGuard, Ownable {
    using SafeMath for uint256;
    using Address for address;
    ...
    // soulSwap
    ISoulSwapRouter private constant soulSwapRouter = ISoulSwapRouter(
        0x6b3d631B87FE27aF29efeC61d2ab8CE4d621cCBF
    );
    ISoulSwapFactory
        private constant soulSwapFactoryAddress = ISoulSwapFactory(
        0x1120e150dA9def6Fe930f4fEDeD18ef57c0CA7eF
    );

    address
        private constant wethTokenAddress = 0x21be370D5312f44cB42ce377BC9b8a0cEF1A4C83;
    ...
    /**
    @notice This function is used to invest in given SoulSwap pair through ETH/ERC20 Tokens
    @param _FromTokenContractAddress The ERC20 token used for investment (address(0x00) if ether)
    @param _pairAddress The SoulSwap pair address
    ...
    {
        IUniswapV2Pair soulPair = IUniswapV2Pair(_pairAddress);
    ...
    function _performZapIn(
        ...
        if (
            _FromTokenContractAddress != _ToSoulpoolToken0 &&
            _FromTokenContractAddress != _ToSoulpoolToken1
        ) {
    ...
    function _soulDeposit(
        ...
        IERC20(_ToUnipoolToken0).safeApprove(address(soulSwapRouter), 0);
        IERC20(_ToUnipoolToken1).safeApprove(address(soulSwapRouter), 0);
        ...
        (uint256 amountA, uint256 amountB, uint256 LP) = soulSwapRouter
            .addLiquidity(
            _ToUnipoolToken0,
            _ToUnipoolToken1,
            token0Bought,
    ...
    function _swapIntermediate(
        ...
        IUniswapV2Pair pair = IUniswapV2Pair(
            soulSwapFactoryAddress.getPair(
                _ToSoulpoolToken0,
                _ToSoulpoolToken1
            )
        );
    ...
    */
    function _token2Token(
        ...
        address pair = soulSwapFactoryAddress.getPair(
            _FromTokenContractAddress,
